class MeasurementsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @measurement.save
        format.html { redirect_to measurement_path(@measurement), notice: 'Measurement was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @measurement.update_attributes(params[:measurement])
        format.html { redirect_to measurement_path(@measurement), notice: 'Measurement was successfully updated.' }
